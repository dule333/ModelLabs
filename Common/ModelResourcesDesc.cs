...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.TERMINAL_CONTROLS);
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_CONDEQS);
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONDEQ_CONTROLS);
			notSettablePropertyIds.Add(ModelCode.REACTIVECAPABILITYCURVE_SYNCHS);
		}
